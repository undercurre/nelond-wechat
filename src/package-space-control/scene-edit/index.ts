...
import { deviceStore, projectStore, sceneStore } from '../../store/index'
  ...
  methods: {
    ...
    async handleSave() {
      ...
      if (this.data._isEditAction) {
        ...
        wx.redirectTo({
          url: strUtil.getUrlWithParams('/package-space-control/scene-request-list/index', { sceneId: data.sceneId }),
        })
